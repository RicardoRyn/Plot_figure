...
__all__ = [
    ...
    'fetch_fslr', 'fetch_rjx_hcpmacaque', 'fetch_mni152', 'fetch_regfusion', 'get_atlas_dir',
    'DENSITIES', 'ALIAS', 'available_annotations', 'available_tags',
    'fetch_annotation'
]  # 增加了“'fetch_rjx_hcpmacaque'” by RJX
...
from .atlases import (fetch_all_atlases, fetch_atlas, fetch_civet,  # noqa
                      fetch_fsaverage, fetch_fslr, fetch_rjx_hcpmacaque, fetch_mni152,
                      fetch_regfusion, get_atlas_dir, DENSITIES, ALIAS)  # 增加了“fetch_rjx_hcpmacaque” by RJX
