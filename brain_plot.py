...
def plot_human_brain_figure(
    ...
    if atlas == "glasser":
        ...
        rh_atlas_dir = op.join(
            ...
            "atlases",
            "rjx_Glasser_atlas",
            "fsaverage.R.Glasser.32k_fs_LR.label.gii",
        )
        ...
        lh_atlas_dir = op.join(
            ...
            "atlases",
            "rjx_BNA_atlas",
            "fsaverage.L.BNA.32k_fs_LR.label.gii",
        )
        rh_atlas_dir = op.join(
            current_dir,
            "neuromaps-data",
            "atlases",
            "rjx_BNA_atlas",
            "fsaverage.R.BNA.32k_fs_LR.label.gii",
        )
...
def plot_macaque_brain_figure(
    ...
    if atlas == "charm5":
        ...
        lh_atlas_dir = op.join(
            ...
            "neuromaps-data",
            "atlases",
            "rjx_BNA_macaque_atlas",
            "MBNA_124_32k_L.label.gii",
        )
        rh_atlas_dir = op.join(
            current_dir,
            "neuromaps-data",
